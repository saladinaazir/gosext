...
function Samira:Draw()
	...
	if self.Menu.MiscSet.Drawing.DrawCombo:Value() then
		local posX = self.Menu.MiscSet.Drawing.ComboposX:Value()-100
		...
		if self.Menu.ComboSet.SafeComboEnable:Value() then
			...
			DrawText("Combo: OFF", 30, posX, posY, DrawColor(255, 0, 255, 0))
		else
			DrawText("Combo: ON", 30, posX, posY, DrawColor(255, 225, 0, 0))
		end
	end
