...
function LoadScript()
	...
	Menu.Combo:MenuElement({id = "UseW", name = "[W]", value = false, toggle=true, key=string.byte("S")})
	...
	Callback.Add("Draw", function()
        ...
        Draw.Text("W: On ",20,myHero.pos:To2D(),Draw.Color(255 ,0,255,0))
    else
        Draw.Text("W: Off ",20,myHero.pos:To2D(),Draw.Color(255 ,255,0,0))
